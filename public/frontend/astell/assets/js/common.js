    ...
    const mediaObj = {
        ...
        quickBtn: function () {
            $(".quick .btn-star")
                ...
                .click(function () {
                    let quickWidth = $(
                        ".side-group .quick .inner .txt"
                    ).width();
                    $(this).fadeOut(300);
                    $(".side-group .quick .inner").css(
                        "width",
                        quickWidth + 79
                    );
                });
        ...
        swiperKeyVisual: function () {
            let timeout = null;
            let waiting = 5000;
            let firstType = $(".key-visual .swiper-wrapper .swiper-slide")
                .eq(0)
                .data().slideType;
            let players = [];
            let options = {};
            ...
            let firstVdo = $(
                ".key-visual .swiper-container .swiper-slide[data-swiper-slide-index = 0]:first video"
            ).get(0);
        ...
        swiperProductBanner: function () {
            ...
            let swiperProduct = new Swiper(
                ".main .product-banner .swiper-container",
                {
                    effect: "fade",
                    speed: 600,
                    parallax: true,
            ...
            // added by kimsoft
            $(".main .product-banner .prev-info").html(
                $(".main .product-banner .swiper-slide:eq(0) .txt2").text()
            );
            $(".main .product-banner .next-info").html(
                $(".main .product-banner .swiper-slide:eq(2) .txt2").text()
            );
            ...
            swiperProduct.on("slideChangeTransitionEnd", function () {
                ...
                var prevBannerName = $(
                    ".main .product-banner .swiper-slide:eq(" +
                        prevIdx +
                        ") .txt2"
                ).text();
        ...
        swiperProductList: function () {
            ...
            for (let i = 0; i < 4; i++) {
                let productSwiper = new Swiper(
                    ".main .product .n" + (i + 1) + " .wl .swiper-container",
                    {
                        slidesPerView: 1,
                        loop: {
                            loop: true,
                        ...
                        navigation: {
                            nextEl:
                                ".main .product .n" +
                                (i + 1) +
                                " .wl .swiper-button-next",
                            prevEl:
                                ".main .product .n" +
                                (i + 1) +
                                " .wl .swiper-button-prev",
                        },
                    }
                );
                ...
                productSwiper.on("transitionEnd", function () {
                    ...
                    $.each(tempThumbSwiper.slides, function (key, row) {
                        tempThumbSwiper.slides[
                            key
                        ].firstElementChild.classList.remove("active");
                    });
                    tempThumbSwiper.slides[
                        productSwiper.realIndex
        ...
        swiperProductThumb: function () {
            ...
            for (let i = 0; i < 4; i++) {
                ...
                let thumbSwiper = new Swiper(
                    ".main .product .n" + (i + 1) + " .wr .swiper-container",
                    {
                        init: true,
                        loop: false,
                        slidesPerView: "auto",
                ...
                let progress = $(
                    ".main .product .n" +
                        (i + 1) +
                        " .wr .swiper-progress-bar .progress"
                );
                ...
                let slidersCount =
                    swiperLength -
                    Math.round(swiperWidth / swiperEachWidth) +
                    1;
                //슬라이더 2~스와이프 가능한 총 갯수만큼 지정
                let slider = $(
                    ".main .product .n" + (i + 1) + " .wr .swiper-slider"
                ).slider({
                    min: 1,
                    max: slidersCount + 1,
                    range: "min",
                ...
                thumbSwiper.on("transitionEnd", function () {
                    ...
                    let progressCnt =
                        Math.ceil(-thumbSwiper.translate / swiperEachWidth) + 1;
                ...
                thumbSwiper.on("click", function () {
                    ...
                    $(".main .product .tmpProductInfo").hide();
                    $(
                        ".main .product .tmpProductInfo_" + this.clickedIndex
                    ).show();
                    // END : added by kimsoft
                });
        ...
        swiperExperience: function () {
            let timeout = null;
            let waiting = 5000;
            let firstType = $(".main .experience .swiper-wrapper .swiper-slide")
                .eq(0)
                .data().slideType;
            let players = [];
            let options = {};

            let swiperExperience = new Swiper(
                ".main .experience .swiper-container",
                {
                    loop: true,
                    effect: "fade",
                    navigation: {
            ...
            let firstVdo = $(
                ".main .experience .swiper-wrapper .swiper-slide[data-swiper-slide-index = 0]:first video"
            ).get(0);
            ...
            // added by kimsoft
            var prevExpType = $(".main .experience .swiper-slide:eq(0)").data(
                "slide-type"
            );
            if (prevExpType == "img") {
                $(".main .experience .swiper-button-prev .bg").css(
                    "background-image",
                    $(".main .experience .swiper-slide:eq(0) .bg").css(
                        "background-image"
                    )
                );
            } else {
                var prevExpUrl = $(
                    ".main .experience .swiper-slide:eq(0) .video-js"
                )
                    .find("source")
                    .attr("src");
                var html =
                    '<video class="video-js"><source src="' +
                    prevExpUrl +
                    '" type="video/mp4"></video>';
                $(".main .experience .swiper-button-prev .bg").addClass("vdo");
                $(".main .experience .swiper-button-prev .bg").html(html);
            }
            var nextExpType = $(".main .experience .swiper-slide:eq(2)").data(
                "slide-type"
            );
            if (nextExpType == "img") {
                $(".main .experience .swiper-button-next .bg").css(
                    "background-image",
                    $(".main .experience .swiper-slide:eq(2) .bg").css(
                        "background-image"
                    )
                );
            } else {
                var nextExpUrl = $(
                    ".main .experience .swiper-slide:eq(2) .video-js"
                )
                    .find("source")
                    .attr("src");
                var html =
            ...
            swiperExperience.on("slideChangeTransitionEnd", function () {
                // added by kimsoft
                $(".main .experience .swiper-button-prev .bg").removeClass(
                    "vdo"
                );
                ...
                $(".main .experience .swiper-button-next .bg").removeClass(
                    "vdo"
                );
                ...
                var prevIdx = this.realIndex;
                var prevExpType = $(
                    ".main .experience .swiper-slide:eq(" + prevIdx + ")"
                ).data("slide-type");
                if (prevExpType == "img") {
                    $(".main .experience .swiper-button-prev .bg").css(
                        "background-image",
                        $(
                            ".main .experience .swiper-slide:eq(" +
                                prevIdx +
                                ") .bg"
                    ...
                    var html =
                        ...
                        prevExpUrl +
                        '" type="video/mp4"></video>';
                    $(".main .experience .swiper-button-prev .bg").addClass(
                        "vdo"
                    );
                    $(".main .experience .swiper-button-prev .bg").html(html);
                }
                ...
                var nextIdx = this.realIndex + 2;
                var nextExpType = $(
                    ".main .experience .swiper-slide:eq(" + nextIdx + ")"
                ).data("slide-type");
                if (nextExpType == "img") {
                    $(".main .experience .swiper-button-next .bg").css(
                        "background-image",
                    ...
                    var html =
                        ...
                        nextExpUrl +
                        '" type="video/mp4"></video>';
                    $(".main .experience .swiper-button-next .bg").addClass(
                        "vdo"
                    );
                    $(".main .experience .swiper-button-next .bg").html(html);
                }
        ...
        swiperNews: function () {
            ...
            //스와이퍼 이동 가능한 총 개수
            let slidersCount =
                swiperLength - Math.round(swiperWidth / swiperEachWidth) + 1;
            //슬라이더 2~스와이프 가능한 총 갯수만큼 지정
            ...
            mySwiper.on("transitionEnd", function () {
                ...
                let progressCnt =
                    Math.ceil(-mySwiper.translate / swiperEachWidth) + 1;
                //translate가 0부터 스와이프 각 객체의 가로만큼 -됨. 현재는 -153씩
                slider.slider("value", progressCnt + 1); //slide는 2부터시작이므로 +1

                $.each(mySwiper.slides, function (key, row) {
                    mySwiper.slides[key].firstElementChild.classList.remove(
                        "active"
                    );
                });
                mySwiper.slides[
        ...
        swiperMoreProduct: function () {
            ...
            let swiperTab = new Swiper(
                ".sub .more-product .tab .swiper-container",
                {
                    watchOverflow: true,
            ...
            let mySwiper = new Swiper(
                ".sub .more-product .list .swiper-container",
                {
                    init: true,
                    loop: false,
                    slidesPerView: "auto",
            ...
            //리스트 전체갯수
            let progress = $(
                ".sub .more-product .list .swiper-progress-bar .progress"
            );
            let swiperLength = mySwiper.slides.length;
            //스와이퍼 가로전체길이
            let swiperWidth = mySwiper.width;
                ...
                .click(function () {
                    ...
                    if ($(this).closest(".swiper-container").hasClass("v1")) {
                        if ($(this).hasClass("m1")) {
                            ...
                            $("html, body").animate(
                                { scrollTop: offsetM2.top - offsetTopH },
                                400
                            );
                        } else if ($(this).hasClass("m3")) {
                            $("html, body").animate(
                                { scrollTop: offsetM3.top - offsetTopH },
                                400
                            );
                        }
                    }
            ...
            $(".list-ty1 .color-dot a")
                ...
                .click(function () {
                    ...
                    $(this)
                        .parents(".txt-area")
                        .prev()
                        .find("li[data-num=" + num + "]")
                        .addClass("on");
                });
        },
        //02_dap_list > color-dot
        colorDot2: function () {
            $(".list-ty2 .color-dot a")
                .off()
                .click(function () {
                    let num = $(this).data().num;
                    $(this).closest(".color-dot").find("a").removeClass("on");
        ...
        swiperDesignList: function () {
            //제품 탭 배열
            let productSwiper = new Swiper(
                ".design-group .list .swiper-container",
                {
                    slidesPerView: 1,
                    loop: {
                        loop: true,
        ...
        swiperDesignThumb: function () {
            ...
            let sliderMoving = false;
            let thumbSwiper = new Swiper(
                ".design-group .thumb .swiper-container",
                {
                    init: true,
                    loop: false,
                    slidesPerView: "auto",
            ...
            //리스트 전체갯수
            let progress = $(
                ".design-group .thumb .swiper-progress-bar .progress"
            );
            let swiperLength = thumbSwiper.slides.length;
            //스와이퍼 가로전체길이
            let swiperWidth = thumbSwiper.width;
        ...
        swiperDetailVisual: function () {
            let swiperDetailVisual = new Swiper(
                ".sub-visual3 .bg .swiper-container",
                {
                    loop: true,
                    pagination: {
                    ...
                    if (mediaVideo) {
                        ...
                        if (tmpVideoSrc) {
                            ...
                            $(this)
                                .next()
                                .find("iframe:first")
                                .attr("src", tmpVideoSrc);
                        }
                    }
                    $(".popup-media").fadeOut(300);
                });
            $('*[data-type="popMediaOpenN1"]')
                .off()
                .click(function () {
                    $(".popup-media.n1").fadeIn(300);
                });
            $('*[data-type="popMediaOpenN2"]')
                .off()
                .click(function () {
                    $(".popup-media.n2").fadeIn(300);
                });
            $('*[data-type="popMediaOpenN3"]')
                .off()
                .click(function () {
                    $(".popup-media.n3").fadeIn(300);
                });
            $('*[data-type="popMediaOpenN4"]')
                .off()
                .click(function () {
        ...
        selectType: function () {
            ...
            $(document).click(function (e) {
                if (e.target.className == "select-ty") {
                    return false;
                }
                $(".select-ty a").removeClass("active");
                $(".select-ty ul").slideUp(200);
        ...
        selectType3: function () {
            ...
            $(document).click(function (e) {
                if (e.target.className == "select-ty3") {
                    return false;
                }
                $(".select-ty3 a").removeClass("active");
                $(".select-ty3 .scroll-y").slideUp(200);
