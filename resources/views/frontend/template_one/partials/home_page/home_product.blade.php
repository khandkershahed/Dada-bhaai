@php
    // Fetching categories (limit to 4 categories)
    $categorys = App\Models\Admin\Category::where('status', '1')->orderBy('id', 'ASC')->limit(4)->get();
    // Fetching all products (without any category filtering)
                    ...
                    <div class="all__product--menu mb-30">
                        <nav>
                            <div class="nav nav-tabs d-flex justify-content-center" id="nav-tab" role="tablist">
                                ...
                                <!-- Loop through categories and create category-specific tabs -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <!-- "All Products" Tab -->
                        <div class="tab-pane fade show active" id="categorys" role="tabpanel"
                                        ...
                                        <div class="product-image">
                                            ...
                                            <ul class="product-links">
                                                <li><a type="submit" class="add_to_wishlist" style="cursor: pointer;"
                                                        data-product_id="{{ $cat_product->id }}" data-tip="Wishlist"><i
                                                            class="far fa-heart"></i></a></li>
                                                <li><a type="submit" style="cursor:pointer;" class="add_to_compare"
                                                        data-product_id="{{ $cat_product->id }}" data-tip="Compare"><i
