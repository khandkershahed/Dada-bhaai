                ...
                @forelse ($products as $product)
                    <div class="col-lg-3 col-md-6">
                        <div class="product-grid mb-4">
                            ...
                            <div class="product-content d-flex justify-content-between align-items-center">
                                ...
                                <div class="price font-weight-bold pr-2">
                                    ...
                                    @elseif ($product->price_status == 'offer_price')
                                        ...
                                        <h6 class="grenadier-color mb-0 font-weight-bold">Tk {{ $product->discount_price }}
                                        </h6>
                            ...
                            <div>
                                <a type="submit" style="cursor:pointer;" class="add-cart" data-product_id="{{ $product->id }}">Add to cart</a>
                            </div>
                        </div>
                    </div>
                @empty
