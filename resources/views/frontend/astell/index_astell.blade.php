            ...
            <ul class="swiper-wrapper">
                <li class="swiper-slide" data-slide-type="vdo">
                    <video class="video-js" muted controls autoplay playsinline>
                        <source
                            src="https://main-images/main_page_key_visual/202209/20220913110058_c4206e91-5c98-4f5b-81d3-7cfd0b81fe29.mp4"
                            type="video/mp4" />
                    </video>
                    <div class="txt">
          ...
          <div class="wrap">
                ...
                <ul class="swiper-wrapper">
                  <li class="swiper-slide">
                    <a href="product_detail.html">
                      <img
                      src="https://i.ibb.co/GHsdRjP/20220905141635-3d2f686c-ea69-4ab8-90bd-9aaeff9e727d.png"
            ...
            <div class="wr">
              ...
              <div class="btn-group tmpProductInfo tmpProductInfo_0">
                <a href="" class="lnk-ty1"
                  >Find store</a
                >
                <div class="mark-group">
                  <img
                    src="https://i.ibb.co/Tbdf3yk/20221109162717-caaf539d-336d-4eff-90b1-e9711f8f4af1.png"
                    alt="1.png"
                  />
                  <img
                    src="https://i.ibb.co/Tbdf3yk/20221109162717-caaf539d-336d-4eff-90b1-e9711f8f4af1.png"
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_1"
                style="display: none"
                >SP2000T</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_1"
                style="display: none">
                <a href="" class="lnk-ty1"
                  >Find store</a
                >
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_2"
                style="display: none"
                >SP2000</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_2"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_3"
                style="display: none"
                >SP1000</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_3"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_4"
                style="display: none"
                >SP1000M</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_4"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_5"
                style="display: none"
                >SP1000M GOLD</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_5"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_6"
                style="display: none"
                >SE300</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_6"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_7"
                style="display: none"
                >SE180</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_7"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_8"
                style="display: none"
                >SE200</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_8"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_9"
                style="display: none"
                >SE100</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_9"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_10"
                style="display: none"
                >SE100 M.Chat</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_10"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_11"
                style="display: none"
                >SR35</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_11"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_12"
                style="display: none"
                >SR25 MKII</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_12"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_13"
                style="display: none"
                >SR25</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_13"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_14"
                style="display: none"
                >SR15</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_14"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_15"
                style="display: none"
                >KANN MAX</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_15"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_16"
                style="display: none"
                >KANN ALPHA</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_16"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_17"
                style="display: none"
                >KANN CUBE</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_17"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_18"
                style="display: none"
                >KANN</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_18"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_19"
                style="display: none"
                >SA700</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_19"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_20"
                style="display: none"
                >AK380</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_20"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_21"
                style="display: none"
                >AK380 Copper</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_21"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_22"
                style="display: none"
                >AK380 Stainless Steel Package</strong
              >
              <p
                class="tmpProductInfo tmpProductInfo_22"
                style="display: none"
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_22"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_23"
                style="display: none"
                >AK320</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_23"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_24"
                style="display: none"
                >AK300</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_24"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_25"
                style="display: none"
                >AK240</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_25"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_26"
                style="display: none"
                >AK240SS</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_26"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_27"
                style="display: none"
                >AK240 BLUENOTE</strong
              >
              <p
                class="tmpProductInfo tmpProductInfo_27"
                style="display: none"
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_27"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_28"
                style="display: none"
                >AK120 II</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_28"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_29"
                style="display: none"
                >AK100 II</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_29"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_30"
                style="display: none"
                >AK70 MK II</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_30"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_31"
                style="display: none"
                >AK70</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_31"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_32"
                style="display: none"
                >AK Jr</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_32"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_33"
                style="display: none"
                >AK120</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_33"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_34"
                style="display: none"
                >AK120 TITAN</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_34"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_35"
                style="display: none"
                >AK100</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_35"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
                ...
                <div class="swiper-container">
                  <ul class="swiper-wrapper">
                    ...
                    <li class="swiper-slide">
                      <a href="product_detail.html">
                        <img
                          src="https://i.ibb.co/7SGrNtm/20211025143709-378311f6-21cb-428d-ab9c-0cfd53627ed6.png"
                          alt="sp2000t_01.png"
                        />
                        <span>SP2000T</span>
                      </a>
            ...
            <div class="wl">
              <div class="swiper-container">
                <ul class="swiper-wrapper">
                  <li class="swiper-slide">
                    <img
                      src="https://i.ibb.co/yRwq24K/20211018114047-399edf7e-f5e9-45be-91d6-e8f3f7c45aee.png"
            ...
            <div class="wl">
              <div class="swiper-container">
                <ul class="swiper-wrapper">
                  <li class="swiper-slide">
                    <img
                      src="https://i.ibb.co/ws3fKXh/20230112101251-d308fd99-c6cc-411a-a978-9d0bd6f36679.png"
        ...
        >
          <div class="wrap">
            <div class="wl">
              <div class="swiper-container">
                <ul class="swiper-wrapper">
                  <li class="swiper-slide">
                    <img
                      src="https://i.ibb.co/dWkXd2S/20230511165947-ce722c38-f080-4ca5-8410-3273bc24e015.png"
            ...
            <div class="wr">
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_36"
                style="display: none"
                >DEF21</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_36"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_37"
                style="display: none"
                >PEF31</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_37"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_38"
                style="display: none"
                >PEF30</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_38"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_39"
                style="display: none"
                >PEF29</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_39"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_40"
                style="display: none"
                >PEF28</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_40"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_41"
                style="display: none"
                >PEE12</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_41"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_42"
                style="display: none"
                >PEF25</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_42"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_43"
                style="display: none"
                >PEF24</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_43"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_44"
                style="display: none"
                >PEF23</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_44"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_45"
                style="display: none"
                >PEF22</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_45"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_46"
                style="display: none"
                >PEF16</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_46"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_47"
                style="display: none"
                >PEF15</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_47"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_48"
                style="display: none"
                >PEF14</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_48"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_49"
                style="display: none"
                >PEF13</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_49"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_50"
                style="display: none"
                >PEF12</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_50"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_51"
                style="display: none"
                >PEF21</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_51"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_52"
                style="display: none"
                >PEF11</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_52"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_53"
                style="display: none"
                >AK PA10</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_53"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_54"
                style="display: none"
                >SEM4</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_54"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_55"
                style="display: none"
                >SEM3</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_55"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_56"
                style="display: none"
                >SEM2</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_56"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_57"
                style="display: none"
                >SP1000 AMP</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_57"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_58"
                style="display: none"
                >AK380 AMP Copper</strong
              >
              <p
                class="tmpProductInfo tmpProductInfo_58"
                style="display: none"
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_58"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_59"
                style="display: none"
                >AK380 AMP</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_59"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_60"
                style="display: none"
                >AK10</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_60"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_61"
                style="display: none"
                >AK XB10</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_61"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_62"
                style="display: none"
                >CD RIPPER MKII</strong
              >
              <p
                class="tmpProductInfo tmpProductInfo_62"
                style="display: none"
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_62"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_63"
                style="display: none"
                >CD RIPPER</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_63"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_64"
                style="display: none"
                >PEM13</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_64"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_65"
                style="display: none"
                >PEM12</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_65"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_66"
                style="display: none"
                >PEM11</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_66"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_67"
                style="display: none"
                >AKS02</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_67"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_68"
                style="display: none"
                >AKS01</strong
              >
              <p
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_68"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_69"
                style="display: none"
                >PRF11 AK Recorder Single Kit</strong
              >
              <p
                class="tmpProductInfo tmpProductInfo_69"
                style="display: none"
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_69"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
              ...
              <strong
                class="tmpProductInfo tmpProductInfo_70"
                style="display: none"
                >PRF11 - AK Stereo MIC Kit</strong
              >
              <p
                class="tmpProductInfo tmpProductInfo_70"
                style="display: none"
              ...
              <div
                class="btn-group tmpProductInfo tmpProductInfo_70"
                style="display: none"
              >
                <a href="" class="lnk-ty1"
                  >Find store</a
          ...
          <div class="swiper-container">
            <ul class="swiper-wrapper">
              <li class="swiper-slide">
                <a href="product_detail.html">
                  <div class="img"
                    style="background-image: url('https://i.ibb.co/42DSK0J20211019142133-85e66c54-e93a-41bc-a0c0-1cb772690622.png');
                    ">
                  </div>
                  <span>Exibition</span>
