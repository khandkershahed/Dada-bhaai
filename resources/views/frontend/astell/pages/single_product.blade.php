    ...
    {{-- @if (!empty($sproducts)) --}}
        <main class="sub">
            ...
            @if (!empty($sproducts->row_seven_background_image))
                <section class="detail-group17 scrollAni n19" style="padding-bottom: 570px;">
            ...
            @if (
                ...
                <section class="detail-group8 v1 scrollAni n10">
                    ...
                    <div class="wrap">
                        ...
                        <p></p>
                        <img class="img1"
                            src="{{ asset('storage/single_product/' . $sproducts->row_thirteen_image_one) }}"
                            alt="img" />
                        <h3>{{ $sproducts->row_thirteen_image_two_title }}</h3>
                        <p></p>
                        <img class="img2"
                            src="{{ asset('storage/single_product/' . $sproducts->row_thirteen_image_two) }}"
                            alt="img" />
                    </div>
                </section>
            @endif
            ...
            @if (!empty($sproducts->row_sixteen_background_image) && !empty($sproducts->row_sixteen_image))
                <section class="detail-group29 scrollAni n13">
                    ...
                    <div class="wrap">
                        ...
                        <img style="width: 500px; height: auto;"
                            src="{{ asset('storage/single_product/' . $sproducts->row_sixteen_image) }}"
                            alt="detail_5" />
                    </div>
                </section>
            @endif
                        ...
                        <div
                            ...
                            <ul class="swiper-wrapper" style="transition-duration: 0ms">
                                ...
                                <li class="swiper-slide swiper-slide-active" data-swiper-slide-index="0"
                                    ...
                                    <img
                                        src="{{ asset('storage/single_product/' . $sproducts->row_nineteen_image_one) }}" />
                                ...
                                <li class="swiper-slide swiper-slide-active" data-swiper-slide-index="0"
                                    style="width: 450px;transition-duration: 0ms;opacity: 1;transform: translate3d(-450px, 0px, 0px);">
                                    <img
                                        src="{{ asset('storage/single_product/' . $sproducts->row_nineteen_image_two) }}" />
