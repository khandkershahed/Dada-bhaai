            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="javascript:;" class="text-muted text-hover-primary">Edit Employee Details</a>
                    </li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
                    ...
                    <div class="stepper stepper-pills" id="kt_stepper_example_basic">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-5 shadow-sm p-5">
                                <!--begin::Form-->
                                <form class="form" novalidate="novalidate" action="{{ route('update.employee.details') }}"
                                    method="POST" id="kt_stepper_example_basic_form" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-5">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" value="{{ $editEmployee->name }}"
                                                            placeholder="Name"
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="email" value="{{ $editEmployee->alternate_email }}"
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="birth_date" value="{{ $editEmployee->birth_date }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ $editEmployee->nid_bri_ppn }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Address"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="address" value="{{ $editEmployee->address }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="City"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="city" value="{{ $editEmployee->city }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Postal"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="postal" value="{{ $editEmployee->postal }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="role"
                                                            ...
                                                            <option></option>
                                                            <option value="admin"
                                                                {{ $editEmployee->role == 'admin' ? 'selected' : '' }}>Admin
                                                            </option>
                                                            <option value="manager"
                                                                {{ $editEmployee->role == 'manager' ? 'selected' : '' }}>
                                                                Manager</option>
                                                            <option value="other"
                                                                {{ $editEmployee->role == 'other' ? 'selected' : '' }}>
                                                                Other
                                                            </option>
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select name="employee_department_id"
                                                            ...
                                                            @foreach ($employeeDepartments as $employeeDepartment)
                                                                <option value="{{ $employeeDepartment->id }}"
                                                                    {{ $editEmployee->employee_department_id == $employeeDepartment->id ? 'selected' : '' }}>
                                                        ...
                                                        <select name="employee_category_id"
                                                            ...
                                                            @foreach ($employeeCategories as $employeeCategory)
                                                                <option value="{{ $employeeCategory->id }}"
                                                                    {{ $editEmployee->employee_category_id == $employeeCategory->id ? 'selected' : '' }}>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Father Name"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="father_name" value="{{ $editEmployee->father_name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Father Service"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="father_service"
                                                            value="{{ $editEmployee->father_service }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Mother Name"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="mother_name" value="{{ $editEmployee->mother_name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Mother Service"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="mother_service"
                                                            value="{{ $editEmployee->mother_service }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Brothers Total"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="brothers_total"
                                                            value="{{ $editEmployee->brothers_total }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Sisters Total"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="sisters_total"
                                                            value="{{ $editEmployee->sisters_total }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Sibling Info One"
                                                            ...
                                                            value="{{ $editEmployee->siblings_contact_info_one }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Sibling Info Two"
                                                            ...
                                                            value="{{ $editEmployee->siblings_contact_info_two }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="marital_status"
                                                            ...
                                                            <!-- Blank option for placeholder -->
                                                            <option value="single"
                                                                {{ $editEmployee->marital_status == 'single' ? 'selected' : '' }}>
                                                                Single</option>

                                                            <option value="married"
                                                                {{ $editEmployee->marital_status == 'married' ? 'selected' : '' }}>
                                                                Married</option>

                                                            <option value="divorced"
                                                                {{ $editEmployee->marital_status == 'divorced' ? 'selected' : '' }}>
                                                                Divorced</option>

                                                            <option value="widowed"
                                                                {{ $editEmployee->marital_status == 'widowed' ? 'selected' : '' }}>
                                                                Widowed</option>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Spouse Name"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="spouse_name" value="{{ $editEmployee->spouse_name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Spouse Employer"
                                                            ...
                                                            value="{{ $editEmployee->spouse_employer }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Spouse Phone"
                                                            ...
                                                            value="{{ $editEmployee->spouse_work_phone }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Permanent Address"
                                                            ...
                                                            value="{{ $editEmployee->permanent_address }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Permanent Address City"
                                                            ...
                                                            value="{{ $editEmployee->permanent_address_city }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Permanent Address State"
                                                            ...
                                                            value="{{ $editEmployee->permanent_address_state }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Permanent Address Zip Code"
                                                            ...
                                                            value="{{ $editEmployee->permanent_address_zip_code }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Current Address"
                                                            ...
                                                            value="{{ $editEmployee->current_address }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Current Address City"
                                                            ...
                                                            value="{{ $editEmployee->current_address_city }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Current Address State"
                                                            ...
                                                            value="{{ $editEmployee->current_address_state }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Current Address Zip Code"
                                                            ...
                                                            value="{{ $editEmployee->current_address_zip_code }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="University"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="university" value="{{ $editEmployee->university }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="email" placeholder="Major Subjects"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="major_subjects"
                                                            value="{{ $editEmployee->major_subjects }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Passing Year"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="passing_year"
                                                            value="{{ $editEmployee->passing_year }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Academic Achievements"
                                                            ...
                                                            value="{{ $editEmployee->academic_achievements }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Professional Achievements"
                                                            ...
                                                            value="{{ $editEmployee->professional_achievements }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Social Achievements"
                                                            ...
                                                            value="{{ $editEmployee->social_achievements }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Personal Achievements"
                                                            ...
                                                            value="{{ $editEmployee->personal_achievements }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Training Information"
                                                            ...
                                                            value="{{ $editEmployee->other_training_information_technical_training }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Training Duration Month"
                                                            ...
                                                            value="{{ $editEmployee->technical_training_duration_date }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Orther Training Information"
                                                            ...
                                                            value="{{ $editEmployee->other_training_information_certificate_course }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Orther Training Duration Month"
                                                            ...
                                                            value="{{ $editEmployee->certificate_course_duration_date }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Total Year Experience"
                                                            ...
                                                            value="{{ $editEmployee->total_years_of_job_experience }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Related Experience"
                                                            ...
                                                            value="{{ $editEmployee->total_years_of_related_experience }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Lowest Job Duration"
                                                            ...
                                                            value="{{ $editEmployee->lowest_job_duration_in_past }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Highest Job Duration"
                                                            ...
                                                            value="{{ $editEmployee->highest_job_duration_in_past }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Negative Situation"
                                                            ...
                                                            value="{{ $editEmployee->action_in_negative_situation }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Recent Job Info Company"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_one_company_name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Recent Job Company Address"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_one_address }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Recent Job Designation"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_one_designation }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Recent Job Contact"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_one_contact_no }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Recent Job Duration"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_one_duration }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Job Other Company"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_two_company_name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Job Other Company Address"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_two_address }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Job Other Company Designation"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_two_designation }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Job Other Company Contact"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_two_contact_no }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Job Other Company Duration"
                                                            ...
                                                            value="{{ $editEmployee->recent_job_info_two_duration }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Professional Reference Name"
                                                            ...
                                                            value="{{ $editEmployee->professional_reference_name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Professional Reference Address"
                                                            ...
                                                            value="{{ $editEmployee->professional_reference_address }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Professional Reference Contact"
                                                            ...
                                                            value="{{ $editEmployee->professional_reference_contact_no_one }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ $editEmployee->professional_reference_contact_no_two }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ $editEmployee->professional_reference_contact_relation }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Relative Reference Name"
                                                            ...
                                                            value="{{ $editEmployee->relative_reference_name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Relative Reference Address"
                                                            ...
                                                            value="{{ $editEmployee->relative_reference_address }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Relative Reference Contact One"
                                                            ...
                                                            value="{{ $editEmployee->relative_reference_contact_no_one }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Relative Reference Cont. Two"
                                                            ...
                                                            value="{{ $editEmployee->relative_reference_contact_no_two }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Relative Reference Relation"
                                                            ...
                                                            value="{{ $editEmployee->relative_reference_contact_relation }}">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="tel" placeholder="Home Phone"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="home_phone" value="{{ $editEmployee->home_phone }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="tel" placeholder="Emergency Number"
                                                            ...
                                                            value="{{ $editEmployee->emergency_number }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-5">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Emergency Contact Persion Name"
                                                            ...
                                                            value="{{ $editEmployee->emergency_contact_information_name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ $editEmployee->emergency_contact_information_address }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Emergency Contact Persion City"
                                                            ...
                                                            value="{{ $editEmployee->emergency_contact_information_city }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ $editEmployee->emergency_contact_information_zip_code }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="tel"
                                                            ...
                                                            value="{{ $editEmployee->emergency_contact_information_phone }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ $editEmployee->emergency_contact_information_relationsip }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Social Work"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="concern_with_social_work"
                                                            value="{{ $editEmployee->concern_with_social_work }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" placeholder="Turns Your On Off"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="what_turns_you_on_off"
                                                            value="{{ $editEmployee->what_turns_you_on_off }}">
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Perference Professional
                                                            Life</label>
                                                        <input type="text" placeholder="Perference Professional Life"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="preference_in_professional_life"
                                                            value="{{ $editEmployee->preference_in_professional_life }}">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="flex-column" data-kt-stepper-element="content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Causal Leave</label>
                                                        <input type="tel" placeholder="Causal Leave"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="casual_leave_due_as_on" value="{{ $editEmployee->casual_leave_due_as_on }}">
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Causal Leave Availed</label>
                                                        <input type="tel" placeholder="Causal Leave Availed"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="casual_leave_availed" value="{{ $editEmployee->casual_leave_availed }}">
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Causal Balance Due</label>
                                                        <input type="tel" placeholder="Causal Balance Due"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="casual_balance_due" value="{{ $editEmployee->casual_balance_due }}">
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Earned Leave Due</label>
                                                        <input type="tel" placeholder="Earned Leave Due"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="earned_leave_due_as_on" value="{{ $editEmployee->earned_leave_due_as_on }}">
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Earned Leave Availed</label>
                                                        <input type="tel" placeholder="Earned Leave Availed"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="earned_leave_availed" value="{{ $editEmployee->earned_leave_availed }}">
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Earned Balance Due</label>
                                                        <input type="tel" placeholder="Earned Balance Due"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="earned_balance_due" value="{{ $editEmployee->earned_balance_due }}">
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Medical Leave Due</label>
                                                        <input type="tel" placeholder="Medical Leave Due"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="medical_leave_due_as_on" value="{{ $editEmployee->medical_leave_due_as_on }}">
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Medical Leave Availed</label>
                                                        <input type="tel" placeholder="Medical Leave Availed"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="medical_leave_availed" value="{{ $editEmployee->medical_leave_availed }}">
                                                    </div>
                                                </div>

                                                <div class="col-4">
                                                    <div class="form-group mb-3">
                                                        <label for="" class="mb-2">Medical Balance Due</label>
                                                        <input type="tel" placeholder="Medical Balance Due"
                                                            class="form-control form-control-sm form-control-solid"
                                                            name="medical_balance_due" value="{{ $editEmployee->medical_balance_due }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="date" name="evaluation_date"
                                                            ...
                                                            value="{{ $editEmployee->evaluation_date }}">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="police_verification"
                                                            ...
                                                            <option value="verified"
                                                                {{ $editEmployee->police_verification == 'verified' ? 'selected' : '' }}>
                                                                Verified</option>

                                                            <option value="unverified"
                                                                {{ $editEmployee->police_verification == 'unverified' ? 'selected' : '' }}>
                                                                Unverified</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="acknowledgement"
                                                            ...
                                                            <option value="acknowledged"
                                                                {{ $editEmployee->acknowledgement == 'acknowledged' ? 'selected' : '' }}>
                                                                Acknowledged</option>

                                                            <option value="unacknowledged"
                                                                {{ $editEmployee->acknowledgement == 'unacknowledged' ? 'selected' : '' }}>
                                                                Unacknowledged
                                                            </option>
