                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-solid form-select-sm"
                                                    ...
                                                    <option value="{{ $category->id }}"
                                                        {{ $home->category_tab_one_id == $category->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-3 mb-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-select-solid form-select-sm"
                                                    ...
                                                    data-placeholder="Category Three" data-allow-clear="true" required>
                                                    <option></option>
                                                    @if (count($categorys) > 0)
                                                    @foreach ($categorys as $category)
                                                    <option value="{{ $category->id }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="image_slider_one_description" id="" cols="2"
                                                            rows="2"
                                                            class="form-control">{{ $home->image_slider_one_description }}</textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="image_slider_two_description" id="" cols="2"
                                                            rows="2"
                                                            class="form-control">{{ $home->image_slider_two_description }}</textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="image_slider_three_description" id="" cols="2"
                                                            rows="2"
                                                            class="form-control">{{ $home->image_slider_three_description }}</textarea>
